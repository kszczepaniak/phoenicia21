...
def docs_add(request):
    ...
    def add_document(request):
        ...
        dokument = Dokument(data_dokumentu=request.POST['data_dokumentu'],
                            ...
                            uzytkownik_zglaszajacy=request.user,
                            status='ZT')
        dokument.save()
    ...
    if request.method == 'POST':
        try:
            feedback = ['success', add_document(request)]
        except:
            feedback = ['danger', "Nie udało się dodać dokumentu"]
    else:
        feedback = []
    ...
    context = {'feedback':feedback, 'jednostki':jednostki, 'etykiety':etykiety, 'typy_dokumentow':Dokument.TYP_DOKUMENTU_CHOICES}
